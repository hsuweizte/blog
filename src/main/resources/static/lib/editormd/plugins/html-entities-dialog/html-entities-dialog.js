...
(function () {
    ...
    var factory = function (exports) {
        ...
        exports.fn.htmlEntitiesDialog = function () {
            ...
            var dialogContent = ['<div class="' + classPrefix + 'html-entities-box" style=\"width: 760px;height: 334px;margin-bottom: 8px;overflow: hidden;overflow-y: auto;\">', '<div class="' + classPrefix + 'grid-table">', '</div>', '</div>',].join("\r\n");
